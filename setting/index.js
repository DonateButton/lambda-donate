...
const _createSetting = (dynamodb, organizationID, amount) =>
{
...
const createSetting = _.partial(_createSetting, dynamodb);
const listSettings = _.partial(_listSettings, dynamodb);
